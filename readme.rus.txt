...
нажмите Ctrl+T. Повторное нажатие используйте для его скрытия. Окно Tracks
manager всегда остается поверх остальных окон приложения и работает с активным
в даный момент модулем (его название дублируется в заголовке главного окна).
Если вам часто нужны функции данного инструмента, то вы можете не закрывать его,
а просто отодвинуть в сторону.
...
Для вызова этого инструмента выберите соответствующий пункт в меню Edit или
нажмите Ctrl+Alt+T. Global Transposition позволяет транспонировать отдельные
(или все) дорожки как всего модуля, так и отдельного паттерна, что позволяет
избежать многократного использования Tracks manager. Настройка и использование
аналогично функции Tracks manager.
...
большей компактности производится перенумерация паттернов.
...
24 августа 2002 года - 10 марта 2007 года
