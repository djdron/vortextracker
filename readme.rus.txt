...
касается редактора Pro Tracker 3 на ZX Spectrum, то серия Pro Tracker v3.69x,
выпущенная Alone Coder'ом практически полностью совместима с VT II. Новые
возможности, реализованные в PT v3.7 (TS треки и слайды с нулевой задержкой),
...
1. Транспозиция выделенной области.
2. Прогрессии, чередования.
3. Копирование/вставка для редактора сэмплов и орнаментов.
...
который при этом должен выводиться на второй чип, можно указать в ниспадающем
списке открытых модулей на панели управления главного окна. По умолчанию второй
чип отключен.

Для удобства редактирования двух модулей в режиме TS VT II автоматически
меняет указанный для второго чипа модуль во время смены редактируемого окна,
синхронизирует треки двух окон как во время проигрывания, так и во время
редактирования (как положение курсора в треках, так и их отображение),
автоматически переключает редактируемое окно при достижении курсора крайней
правой или левой позиции в треках.
...
- Ch41ns4w за пожелания по TS-режиму.
...
24 августа 2002 года - 3 октября 2006 года
