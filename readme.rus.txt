...
модуль автоматически преобразуется в два обычных PT3-модуля. Аналогичные модули
PT v3.6 не документированы, поэтому перед импортом VT II производит анализ их
структуры и дает возможность пользователю импортировать либо как TS, либо как
обычные PT3.
...
ограничение - не более ~48 паттернов при длине паттернов не более 64.
...
24 августа 2002 года - 1 мая 2007 года
